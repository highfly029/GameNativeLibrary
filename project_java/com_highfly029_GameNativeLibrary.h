 ...
 * Class:     com_highfly029_GameNativeLibrary
 * Method:    addObstacle
 * Signature: (ILjava/lang/String;FFFFFZ)I
 */
JNIEXPORT jint JNICALL Java_com_highfly029_GameNativeLibrary_addObstacle
  (JNIEnv *, jobject, jint, jstring, jfloat, jfloat, jfloat, jfloat, jfloat, jboolean);

/*
 * Class:     com_highfly029_GameNativeLibrary
 * Method:    addBoxObstacle
 * Signature: (ILjava/lang/String;FFFFFFZ)I
 */
JNIEXPORT jint JNICALL Java_com_highfly029_GameNativeLibrary_addBoxObstacle__ILjava_lang_String_2FFFFFFZ
  (JNIEnv *, jobject, jint, jstring, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jboolean);

/*
 * Class:     com_highfly029_GameNativeLibrary
 * Method:    addBoxObstacle
 * Signature: (ILjava/lang/String;FFFFFFFZ)I
 */
JNIEXPORT jint JNICALL Java_com_highfly029_GameNativeLibrary_addBoxObstacle__ILjava_lang_String_2FFFFFFFZ
  (JNIEnv *, jobject, jint, jstring, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jboolean);

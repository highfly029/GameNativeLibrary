...
clang -c fastlz.c
clang++ -std=c++11 -stdlib=libc++ -c ChunkyTriMesh.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourAlloc.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourAssert.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourCommon.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourNavMesh.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourNavMeshBuilder.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourNavMeshQuery.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourNode.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourTileCache.cpp
clang++ -std=c++11 -stdlib=libc++ -c DetourTileCacheBuilder.cpp
clang++ -std=c++11 -stdlib=libc++ -c MeshLoaderObj.cpp
clang++ -std=c++11 -stdlib=libc++ -c SoloMesh.cpp
clang++ -std=c++11 -stdlib=libc++ -c TempObstacle.cpp

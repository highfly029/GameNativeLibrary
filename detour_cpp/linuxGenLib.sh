...
gcc -c fastlz.c
g++ -std=c++11 -stdlib=libc++ -c ChunkyTriMesh.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourAlloc.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourAssert.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourCommon.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourNavMesh.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourNavMeshBuilder.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourNavMeshQuery.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourNode.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourTileCache.cpp
g++ -std=c++11 -stdlib=libc++ -c DetourTileCacheBuilder.cpp
g++ -std=c++11 -stdlib=libc++ -c MeshLoaderObj.cpp
g++ -std=c++11 -stdlib=libc++ -c SoloMesh.cpp
g++ -std=c++11 -stdlib=libc++ -c TempObstacle.cpp
